...
<script type="text/javascript" src="view/javascript/gixocnotifications/jquery-1.9.1.min.js"></script>
<link rel="stylesheet" type="text/css" href="view/stylesheet/gixocnotifications/bootstrap.min.css" />
<script type="text/javascript" src="view/javascript/gixocnotifications/bootstrap.min.js"></script>
<link rel="stylesheet" type="text/css" href="view/javascript/gixocnotifications/font-awesome/css/font-awesome.min.css" />
<link rel="stylesheet" type="text/css" href="view/stylesheet/gixocnotifications/stylesheet.css" />
</head>
<body>
<div id="container">
<div id="content">
...
function webhook(key) {
  ...
  $.ajax({
    url: 'index.php?route=module/gixocnotifications/set_webhook&token=<?php echo $token; ?>',
    type: 'post',
    dataType: 'json',
...
function clearLog(key) {
  ...
  $("#ModalBox").modal('show');
  $.ajax({
    url: 'index.php?route=module/gixocnotifications/clearLog&token=<?php echo $token; ?>',
    type: 'post',
    dataType: 'json',
    data: 'key=' + key,
    success: function(json) {
...
function downloadLog(key) {
  ...
  $("#ModalBox").modal('show');
  $.ajax({
    url: 'index.php?route=module/gixocnotifications/downloadLog&token=<?php echo $token; ?>' + '&key=' + key,
    type: 'GET',
    success: function(json) {
      if (json['error']) {
        $(".modal-title").html('Error!');
        ...
        $("#ModalBox").modal('hide');
        window.location = 'index.php?route=module/gixocnotifications/downloadLog&token=<?php echo $token; ?>' + '&key=' + key;
      }
    },
    error: function(xhr, ajaxOptions, thrownError) {
      alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
...
function help(key) {
  $("#ModalBox").modal('show');
  $.ajax({
    url: 'index.php?route=module/gixocnotifications/help&token=' + '<?php echo $token; ?>',
    type: 'post',
  dataType: 'json',
    data: 'key=' + key,
    success: function(json) {
